...
var gymModels_1 = require("../models/gymModels");
var db_1 = require("../config/db");
// Load up the environment variables ....
dotenv.config({ path: "./.env" });
// Test fn to create a sample gym entity:
var createSampleGym = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sampleGym, savedGym, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, 3, 4]);
                sampleGym = new gymModels_1.default({
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, createSampleGym()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
